...
export default function ProductCard({
  ...
  return (
    <article className="group relative flex h-full flex-col rounded-lg border border-white/10 bg-white/[0.035] p-2 shadow-[0_18px_60px_rgba(0,0,0,0.18)] transition duration-300 hover:-translate-y-1 hover:border-signal/35 hover:bg-white/[0.055]">
